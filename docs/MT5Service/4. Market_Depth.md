...
2. **Dataclass conversion** (1 method):
   ...
   - `get_market_depth()`: Converts protobuf repeated `BookRecord` → clean `List[BookInfo]` dataclass
...
- [Market Depth (Low-Level)](../API_Reference/MT5Account.md) - low-level DOM API
