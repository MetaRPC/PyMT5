...
> **📌 Важно для новичков:** После выполнения команды пакет установится в ваше виртуальное окружение.
...
grpcio==1.xx.x
protobuf==5.xx.x
# ... другие автоматически установленные зависимости
```
...
- Переустановите пакет: `pip uninstall MetaRpcMT5 && pip install MetaRpcMT5`
